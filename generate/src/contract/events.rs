...
fn expand_filters(cx: &Context) -> Result<TokenStream> {
    ...
    Ok(quote! {
        ...
        pub struct Events<'a> {
            instance: &'a self::ethcontract::private::DynInstance,
        }
...
fn expand_filter(event: &Event) -> Result<TokenStream> {
    ...
    Ok(quote! {
        ...
        pub fn #name(&self) -> self::ethcontract::private::DynEventBuilder<#data> {
...
fn expand_all_events(cx: &Context) -> TokenStream {
    ...
    quote! {
        impl Contract {
            ...
            pub fn all_events(&self) -> self::ethcontract::private::DynLogStream {
